 ...
 * 产权：南京婚尚信息技术
 */
public class JHLShowTypeImageView extends ImageView {
    ...
    public JHLShowTypeImageView(Context context) {
        super(context);
    }

    public JHLShowTypeImageView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public JHLShowTypeImageView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {

...
public class VideoViewContainerHelper {
    ...
    public void loadVideoView(ViewGroup parent, ImageItem imageItem, ICropPickerBindPresenter presenter) {
        ...
        if (videoView == null) {
            ...
            pauseImg.setImageDrawable(context.getResources().getDrawable(R.mipmap.video_play_small));

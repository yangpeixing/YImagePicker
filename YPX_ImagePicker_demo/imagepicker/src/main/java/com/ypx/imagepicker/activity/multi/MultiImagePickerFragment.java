...
public class MultiImagePickerFragment extends Fragment{
    ...
    private RelativeLayout mTitleLayout, mBottomLayout;
    ...
    public static void intent(Activity activity,
        ...
        Intent intent = new Intent(activity, MultiImagePickerFragment.class);
        intent.putExtra(MultiImagePickerFragment.INTENT_KEY_SELECT_CONFIG, selectConfig);
        intent.putExtra(MultiImagePickerFragment.INTENT_KEY_UI_CONFIG, presenter);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        mContentView = inflater.inflate(R.layout.picker_activity_images_grid, container, false);
        return mContentView;
    }
...
//        mTitleRoot = findViewById(R.id.mTitleRoot);
...
//                return;
//            }
//            MultiImagePreviewActivity.preview(MultiImagePickerFragment.this,
...
//            StatusBarUtil.setStatusBar(this, uiConfig.getTopBarBackgroundColor(), false,
...
//            params.topMargin = 0;
//            mTitleRoot.setOnClickListener(new View.OnClickListener() {
//                @Override
//                public void onClick(View v) {
...
//        }
//
//        mTitleRoot.setGravity(uiConfig.getTopBarTitleGravity());
...
//                        mTvTime.setVisibility(View.GONE);
//                        mTvTime.startAnimation(AnimationUtils.loadAnimation(MultiImagePickerFragment.this, R.anim.picker_fade_out));
//                    }
//                } else {
//                    if (mTvTime.getVisibility() == View.GONE) {
//                        mTvTime.setVisibility(View.VISIBLE);
//                        mTvTime.startAnimation(AnimationUtils.loadAnimation(MultiImagePickerFragment.this, R.anim.picker_fade_in));
//                    }
//                }
//            }
//
...
//            mImageSetListView.setAnimation(AnimationUtils.loadAnimation(MultiImagePickerFragment.this,

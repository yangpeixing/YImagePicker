...
public class YPXImagePreviewActivity extends FragmentActivity {
    ...
    private void dealIntentData() {
        ...
        // mImageList = ImagePickerData.getCurrentImageSet().simpleImageItems;
        mImageList = ((ImageSet) (getIntent().getSerializableExtra("ImageSet"))).simpleImageItems;
    ...
    private void initViewPager() {
        ...
        SimpleImageItem item = mImageList.get(mCurrentItemPosition);
    ...
    public void onImagePageSelected(int position, SimpleImageItem item, boolean isSelected) {
    ...
    public static class SinglePreviewFragment extends Fragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            SimpleImageItem simpleImageItem = (SimpleImageItem) bundle.getSerializable(KEY_URL);
            if (simpleImageItem == null) {
                return;
            }
            url = simpleImageItem.path;

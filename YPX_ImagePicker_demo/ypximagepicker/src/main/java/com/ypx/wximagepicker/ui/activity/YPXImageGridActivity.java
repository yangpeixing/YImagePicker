...
import com.ypx.wximagepicker.data.DataSource;
...
public class YPXImageGridActivity extends FragmentActivity implements OnImagesLoadedListener, View.OnClickListener {
    ...
    protected void onResume() {
        super.onResume();
        if (simpleImageItems != null && mAdapter != null) {
            mAdapter.refreshData(simpleImageItems);
            resetBtnOKstate();
        }
    }
    ...
    private void setListener() {
        ...
        gridView.setOnScrollListener(new AbsListView.OnScrollListener() {
            ...
            public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
                if (simpleImageItems != null)
                    try {
                        tv_time.setText(simpleImageItems.get(firstVisibleItem).getTimeFormat());
    ...
    private void initAdapters() {
        ...
        mAdapter = new ImageGridAdapter(this, new ArrayList<SimpleImageItem>(), selectConfig, iImgPickerUIConfig);
    ...
    private void selectImageSet(final int position) {
        ...
        this.simpleImageItems = imageSets.get(position).simpleImageItems;
        ...
        btnDir.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                if (null != imageSet) {
                    mAdapter.refreshData(imageSet.simpleImageItems);
    ...
    public void onImagesLoaded(List<ImageSet> imageSetList) {
        ...
        this.simpleImageItems = imageSetList.get(currentSetIndex).simpleImageItems;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK && requestCode == REQ_PREVIEW) {
            ...
            if (!TextUtils.isEmpty(mCurrentPhotoPath)) {
                ...
                SimpleImageItem item = new SimpleImageItem(mCurrentPhotoPath, "", -1);
     ...
     */
    public void onImageClickListener(SimpleImageItem item, int position) {
        ...
        switch (selectConfig.getSelectMode()) {
            ...
            case ImageSelectMode.MODE_SINGLE:
                List<SimpleImageItem> list2 = new ArrayList<>();
                list2.add(item);
    ...
    public void imageSelectChange(SimpleImageItem simpleImageItem, boolean isChecked) {
        if (isChecked) {

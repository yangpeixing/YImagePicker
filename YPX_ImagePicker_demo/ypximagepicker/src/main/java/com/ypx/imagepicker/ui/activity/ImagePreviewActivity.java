...
public class ImagePreviewActivity extends FragmentActivity implements View.OnClickListener
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mShowItemPosition = getIntent().getIntExtra("key_pic_selected", 0);
        ...
        int selectedCount = YPXImagePicker.getInstance().getSelectImageCount();
    ...
    public void selectCurrent(boolean isCheck) {
        ...
        if (isCheck) {
            if (!isSelect) {
                YPXImagePicker.getInstance().addSelectedImageItem(mCurrentItemPosition, item);
            }
        } else {
            if (isSelect) {
                YPXImagePicker.getInstance().deleteSelectedImageItem(mCurrentItemPosition, item);
            }
        }
